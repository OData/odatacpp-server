...
{
public:
	static std::shared_ptr<_Entity_Impl> create_reader_instance(std::shared_ptr<::odata::edm::edm_model> model, const ::odata::utility::string_t& service_root_url)
	{
	...
	static std::shared_ptr<_Entity_Impl> create_context_url_parser(std::shared_ptr<::odata::edm::edm_model> model, const ::odata::utility::string_t& service_root_url)
	{
		return std::make_shared<_Entity_Impl>(model, service_root_url); 
	}
};

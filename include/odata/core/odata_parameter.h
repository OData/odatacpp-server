...
public:
    ...
    odata_parameter(::odata::utility::string_t name, const std::shared_ptr<::odata::core::odata_value>& value) 
		: m_name(name), m_value(value)
	{
	}
	
	const ::odata::utility::string_t& get_name() const { return m_name; }

	void set_name(const ::odata::utility::string_t& name)
	{
		m_name = name;
	}

//---------------------------------------------------------------------
// <copyright file="odata_json_operation_url_parameter_writer.h" company="Microsoft">
...
public:
	...
	ODATACPP_API ::odata::utility::string_t serialize(std::vector<std::shared_ptr<odata_parameter>> parameters);

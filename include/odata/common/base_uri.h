//---------------------------------------------------------------------
// <copyright file="base_uri.h" company="Microsoft">
...
namespace odata { namespace utility {
    namespace details
    {
        struct _uri_components
        {
            ...
            ODATACPP_API utility::string_t join();
    ...
    public:
        ...
        ODATACPP_API static utility::string_t __cdecl encode_uri(const utility::string_t &raw, uri::components::component = components::full_uri);
        ...
        /// <returns>The encoded string.</returns>
        ODATACPP_API static utility::string_t __cdecl encode_data_string(const utility::string_t &utf8data);
        ...
        ODATACPP_API static utility::string_t __cdecl decode(const utility::string_t &encoded);
...
#pragma region splitting
        ...
        ODATACPP_API static std::vector<utility::string_t> __cdecl split_path(const utility::string_t &path);
        ...
        ODATACPP_API static std::map<utility::string_t, utility::string_t> __cdecl split_query(const utility::string_t &query);
...
#pragma region validation
        ...
        ODATACPP_API static bool __cdecl validate(const utility::string_t &uri_string);
...
#pragma region constructors
        ...
        ODATACPP_API uri(const utility::char_t *uri_string);
        ...
        ODATACPP_API uri(const utility::string_t &uri_string);
...
#pragma region accessors
        ...
        ODATACPP_API uri authority() const;
        ...
        ODATACPP_API uri resource() const;
...
#pragma region operators
        ...
        ODATACPP_API bool operator == (const uri &other) const;

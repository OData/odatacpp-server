//---------------------------------------------------------------------
// <copyright file="uri_builder.h" company="Microsoft">
...
#include "odata/common/base_uri.h"
...
#pragma region Appending
        ...
        ODATACPP_API uri_builder &append_path(const utility::string_t &path, bool do_encoding = false);
        ...
        /// <param name="do_encoding">Specify whether to apply URI encoding to the given string.</param>
        /// <returns>A reference to this uri_builder to support chaining.</returns>
        ODATACPP_API uri_builder &append_query(const utility::string_t &query, bool do_encoding = false);
        ...
        /// <returns>A reference to this uri_builder to support chaining.</returns>
        ODATACPP_API uri_builder &append(const uri &relative_uri);
...
#pragma region URI Creation
        ...
        ODATACPP_API utility::string_t to_string();

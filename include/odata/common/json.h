//---------------------------------------------------------------------
// <copyright file="json.h" company="Microsoft">
...
#ifndef _ODATA_JSON_H
#define _ODATA_JSON_H
...
namespace odata { namespace utility { namespace json
{
    ...
    /// </summary>
    void ODATACPP_API keep_object_element_order(bool keep_order);
...
#define ENABLE_JSON_VALUE_VISUALIZER
    ...
    public:
        ...
        ODATACPP_API value(int32_t value);

        /// <summary>
        /// Constructor creating a JSON number value
        /// </summary>
        /// <param name="value">The C++ value to create a JSON value from</param>
        ODATACPP_API value(uint32_t value);

        /// <summary>
        /// Constructor creating a JSON number value
        /// </summary>
        /// <param name="value">The C++ value to create a JSON value from</param>
        ODATACPP_API value(int64_t value);

        /// <summary>
        /// Constructor creating a JSON number value
        /// </summary>
        /// <param name="value">The C++ value to create a JSON value from</param>
        ODATACPP_API value(uint64_t value);

        /// <summary>
        /// Constructor creating a JSON number value
        /// </summary>
        /// <param name="value">The C++ value to create a JSON value from</param>
        ODATACPP_API value(double value);

        /// <summary>
        /// Constructor creating a JSON Boolean value
        /// </summary>
        /// <param name="value">The C++ value to create a JSON value from</param>
        ODATACPP_API explicit value(bool value);
        ...
        ODATACPP_API explicit value(utility::string_t);
        ...
        ODATACPP_API explicit value(const utility::char_t *);

        /// <summary>
        /// Copy constructor
        /// </summary>
        ODATACPP_API value(const value &);

        /// <summary>
        /// Move constructor
        /// </summary>
        ODATACPP_API value(value &&);

        /// <summary>
        /// Assignment operator.
        /// </summary>
        /// <returns>The JSON value object that contains the result of the assignment.</returns>
        ODATACPP_API value &operator=(const value &);

        /// <summary>
        /// Move assignment operator.
        /// </summary>
        /// <returns>The JSON value object that contains the result of the assignment.</returns>
        ODATACPP_API value &operator=(value &&);
        ...
        static ODATACPP_API value __cdecl null();
        ...
        static ODATACPP_API value __cdecl number(double value);
        ...
        /// <param name="value">The C++ value to create a JSON value from</param>
        /// <returns>A JSON number value</returns>
        static ODATACPP_API value __cdecl number(int32_t value);
        ...
        static ODATACPP_API value __cdecl boolean(bool value);
        ...
        static ODATACPP_API value __cdecl string(utility::string_t value);

#ifdef _MS_WINDOWS
private:
        // Only used internally by JSON parser.
        static ODATACPP_API value __cdecl string(const std::string &value);
public:
#endif
        ...
        static ODATACPP_API json::value __cdecl object(bool keep_order = false);
        ...
        static ODATACPP_API json::value __cdecl object(std::vector<std::pair<::odata::utility::string_t, value>> fields, bool keep_order = false);

        /// <summary>
        /// Creates an empty JSON array
        /// </summary>
        /// <returns>An empty JSON array value</returns>
        static ODATACPP_API json::value __cdecl array();
        ...
        static ODATACPP_API json::value __cdecl array(size_t size);
        ...
        /// <returns>A JSON array value</returns>
        static ODATACPP_API json::value __cdecl array(std::vector<value> elements);

        /// <summary>
        /// Accesses the type of JSON value the current value instance is
        /// </summary>
        /// <returns>The value's type</returns>
        ODATACPP_API json::value::value_type __cdecl type() const;
        ...
        ODATACPP_API bool is_integer() const;
        ...
        ODATACPP_API bool is_double() const;
        ...
        ODATACPP_API static value parse(const utility::string_t&);

        /// <summary>
        /// Serializes the current JSON value to a C++ string.
        /// </summary>
        /// <returns>A string representation of the value</returns>
        ODATACPP_API utility::string_t serialize() const;

        /// <summary>
        /// Serializes the current JSON value to a C++ string.
        /// </summary>
        /// <returns>A string representation of the value</returns>
        ODATACPP_API utility::string_t to_string() const;
        ...
        ODATACPP_API static value parse(utility::istream_t &input);
        ...
        ODATACPP_API void serialize(utility::ostream_t &stream) const;
        ...
        ODATACPP_API static value parse(std::istream& stream);

        /// <summary>
        /// Serializes the content of the value into a single-byte (UTF8) stream.
        /// </summary>
        /// <param name="stream">The stream that the JSON string representation should be written to.</param>
        ODATACPP_API void serialize(std::ostream& stream) const;
#endif
        ...
        ODATACPP_API double as_double() const;
        ...
        ODATACPP_API int as_integer() const;
        ...
        ODATACPP_API json::number as_number() const;
        ...
        ODATACPP_API bool as_bool() const;
        ...
        ODATACPP_API json::array& as_array();
        ...
        /// <remarks>The returned <c>json::array</c> should have the same or shorter lifetime as <c>this</c></remarks>
        /// <returns>An array representation of the value</returns>
        ODATACPP_API const json::array& as_array() const;
        ...
        ODATACPP_API json::object& as_object();

        /// <summary>
        /// Converts the JSON value to a json object, if and only if it is an object value.
        /// </summary>
        /// <returns>An object representation of the value</returns>
        ODATACPP_API const json::object& as_object() const;
        ...
        ODATACPP_API utility::string_t as_string() const;
        ...
        ODATACPP_API bool operator==(const value& other) const;
        ...
        ODATACPP_API json::value& at(size_t index);
        ...
        /// <param name="index">The index of an element in the JSON array.</param>
        /// <returns>A reference to the value.</returns>
        ODATACPP_API const json::value& at(size_t index) const;
        ...
        ODATACPP_API json::value& at(const utility::string_t& key);
        ...
        /// <param name="key">The key of an element in the JSON object.</param>
        /// <returns>If the key exists, a reference to the value.</returns>
        ODATACPP_API const json::value& at(const utility::string_t& key) const;
        ...
        ODATACPP_API value & operator [] (const utility::string_t &key);

#ifdef _MS_WINDOWS
private:
        // Only used internally by JSON parser
        ODATACPP_API value & operator [] (const std::string &key)
        {
...
public:
        ...
        /// <param name="index">The index of an element in the JSON array.</param>
        /// <returns>A reference to the value kept in the field.</returns>
        ODATACPP_API value & operator [] (size_t index);

    private:
        friend class odata::utility::json::details::_Object;
        friend class odata::utility::json::details::_Array;
        template<typename CharType> friend class odata::utility::json::details::JSON_Parser;
        ...
        ODATACPP_API void format(std::basic_string<utf16char> &string) const;
#endif
        /// <summary>
        /// Serializes the content of the value into a string instance in UTF8 format
        /// </summary>
        /// <param name="string">The string that the JSON representation should be written to</param>
        ODATACPP_API void format(std::basic_string<char>& string) const;
    ...
    public:
        ...
        json::value& at(const utility::string_t& key)
        {
            ...
            if (iter == m_elements.end() || key != (iter->first))
                throw odata::utility::json::json_exception(_XPLATSTR("Key not found"));
...
#pragma region "is" checkers
        ...
        ODATACPP_API bool is_int32() const;
...
#pragma endregion
    ...
    namespace details
    {
        ...
        private:
            ...
            friend class odata::utility::json::value;
        };
        ...
        public:
            ...
            _String(const _String& other) : odata::utility::json::details::_Value(other)
            {
                copy_from(other);
            }
        ...
        template<typename CharType>
        ODATACPP_API void append_escape_string(std::basic_string<CharType>& str, const std::basic_string<CharType>& escaped);
        ...
        public:
            ...
            ODATACPP_API _Object(const _Object& other);
            ...
            ODATACPP_API virtual json::value &index(const utility::string_t &key);
    ...
    ODATACPP_API utility::ostream_t& operator << (utility::ostream_t &os, const json::value &val);
    ...
    ODATACPP_API utility::istream_t& operator >> (utility::istream_t &is, json::value &val);

}}} // namespace odata::utility::json

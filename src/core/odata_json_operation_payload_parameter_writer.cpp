...
::odata::utility::json::value odata_json_operation_payload_parameter_writer::serialize(std::vector<std::shared_ptr<odata_parameter>> parameters)
{
	if (parameters.empty())
	{
	...
	return odata::utility::json::value::parse(ss);
}

void odata_json_operation_payload_parameter_writer::handle_serialize_odata_parameter(
	::odata::utility::stringstream_t& ss, const std::shared_ptr<::odata::core::odata_parameter>& parameter, ::odata::utility::char_t mark, ::odata::utility::char_t separator)
{
...
void odata_json_operation_payload_parameter_writer::handle_serialize_odata_properties(::odata::utility::stringstream_t& ss, const odata_property_map& properties)
{
...
void odata_json_operation_payload_parameter_writer::handle_serialize_odata_value(
	::odata::utility::stringstream_t& ss, const std::shared_ptr<::odata::edm::edm_named_type>& property_type, const std::shared_ptr<odata_value>& property_value)
{
...
void odata_json_operation_payload_parameter_writer::handle_serialize_primitive_value(
	::odata::utility::stringstream_t& ss, const std::shared_ptr<::odata::edm::edm_primitive_type>& p_primitive_type, const std::shared_ptr<odata_primitive_value>& p_value)
{
...
void odata_json_operation_payload_parameter_writer::handle_serialize_enum_value(::odata::utility::stringstream_t& ss, const std::shared_ptr<odata_enum_value>& p_value)
{
	if (!p_value)
	{
		return ;
...
void odata_json_operation_payload_parameter_writer::handle_serialize_collection_value(::odata::utility::stringstream_t& ss, const std::shared_ptr<odata_collection_value>& p_value)
{
	if (!p_value)
	{
		return ;

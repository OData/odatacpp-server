...
void odata_json_operation_url_parameter_writer::handle_serialize_enum_value(::odata::utility::stringstream_t& ss, const std::shared_ptr<odata_enum_value>& p_value)
{
	if (!p_value)
	{
		return ;

...
TEST(collection_of_navigation_type)
{
	...
	std::istringstream iss(std::move(std::string(test_model_string)));
...
{
	std::istringstream iss(std::move(std::string(edm_model_collection_of_complex_type_test_string)));
	auto model_reader = std::make_shared<edm_model_reader>(iss);
	model_reader->parse();
	auto model = model_reader->get_model();
...
{
	std::istringstream iss(std::move(std::string(edm_model_entity_type_test_string)));
	auto model_reader = std::make_shared<edm_model_reader>(iss);
	model_reader->parse();
	auto model = model_reader->get_model();
	VERIFY_IS_NOT_NULL(model);
...
{
	std::istringstream iss(std::move(std::string(edm_model_complex_type_test_string)));
	auto model_reader = std::make_shared<edm_model_reader>(iss);
	model_reader->parse();
	auto model = model_reader->get_model();
	VERIFY_IS_NOT_NULL(model);
...
{
	std::istringstream iss(std::move(std::string(edm_model_enum_type_test_string)));
	auto model_reader = std::make_shared<edm_model_reader>(iss);
	model_reader->parse();
	auto model = model_reader->get_model();
	VERIFY_IS_NOT_NULL(model);
...
{
	std::istringstream iss(std::move(std::string(edm_model_version_test_string)));
	auto model_reader = std::make_shared<edm_model_reader>(iss);
	model_reader->parse();
	auto model = model_reader->get_model();
	VERIFY_IS_NOT_NULL(model);

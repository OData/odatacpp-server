...
TEST(primitive_value)
{
	...
	//date time
	::odata::utility::datetime dt = ::odata::utility::datetime::from_string(U("2014-5-13T11:40:00Z"), ::odata::utility::datetime::date_format::ISO_8601);
	...
	auto ck_dt = date_v->as<::odata::utility::datetime>();
	VERIFY_ARE_EQUAL(ck_dt, dt);

	//duration
	::odata::utility::seconds sd(3600);
	...
	auto ck_second = second_v->as<::odata::utility::seconds>();
	...
	VERIFY_ARE_EQUAL(str_v->as<::odata::utility::string_t>(), U("test string"));
}
...
TEST(structured_value)
{
	...
	::odata::utility::datetime dt = ::odata::utility::datetime::from_string(U("2013-12-31T00:00:00Z"), ::odata::utility::datetime::date_format::ISO_8601);
	structurd_value->set_value(U("datetime"), dt);
	::odata::utility::char_t* ch_str = U("char_t pointer input");
	structurd_value->set_value(U("char_t pointer"), ch_str);
	::odata::utility::string_t str = U("string_t input");
	...
	VERIFY_ARE_EQUAL(b_get, true);
	VERIFY_ARE_EQUAL(dt.to_string(::odata::utility::datetime::date_format::ISO_8601), U("2013-12-31T00:00:00Z"));
...
TEST(primitive_collection_value)
{
	...
	auto collection_type = std::make_shared<edm_collection_type>(::odata::edm::edm_primitive_type::DOUBLE());
	auto collection_value = std::make_shared<odata_collection_value>(collection_type);

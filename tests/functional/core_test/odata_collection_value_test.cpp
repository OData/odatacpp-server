...
TEST(collection_of_primitive_value)
{
	...
	shared_ptr<edm_collection_type> collection_type = std::make_shared<edm_collection_type>(int_type);
...
TEST(collection_of_enum_value)
{
	...
	auto collection_type = std::make_shared<edm_collection_type>(enum_type);

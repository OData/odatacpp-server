...
typedef std::unordered_map<::odata::utility::string_t, ::odata::utility::string_t> map_type;
const map_type::value_type init_test_values[] = 
{
	...
	map_type::value_type(U("unicode_data_in_entity"), U("{\"AccountID\":100,\"Country\":\"上海\"}")),
...
TEST(collection_of_entity)
{
	...
	auto collection_type = std::make_shared<edm_collection_type>(model->find_entity_type(U("Account")));
...
TEST(collection_of_complex)
{
	...
	auto collection_type = std::make_shared<edm_collection_type>(model->find_complex_type(U("AccountInfo")));
	auto collection_value = std::make_shared<odata_collection_value>(collection_type);
...
TEST(single_primitive)
{
	...
	auto int32_value = std::make_shared<odata_primitive_value>(edm_primitive_type::INT32(), ::odata::utility::conversions::print_string(100));
...
TEST(single_primitive_int16_min)
{
	...
	int16_t value = -32768;
	auto odata_value = std::make_shared<odata_primitive_value>(edm_primitive_type::INT16(), ::odata::utility::conversions::print_string(value));
...
TEST(single_primitive_int32_max)
{
	...
	auto odata_value = std::make_shared<odata_primitive_value>(edm_primitive_type::INT32(), ::odata::utility::conversions::print_string(value));
	auto json_string = json_writer->serialize(odata_value).to_string();
...
TEST(single_primitive_int64_max)
{
	...
	auto odata_value = std::make_shared<odata_primitive_value>(edm_primitive_type::INT64(), ::odata::utility::conversions::print_string(value));
	auto json_string = json_writer->serialize(odata_value).to_string();
...
TEST(single_primitive_duration)
{
	...
	auto value = ::odata::utility::datetime::from_string(U("2013-12-31T00:00:00Z"), ::odata::utility::datetime::date_format::ISO_8601);
	auto odata_value = odata_primitive_value::make_primitive_value(value);
	auto json_string = json_writer->serialize(odata_value).to_string();
...
TEST(single_primitive_datetime)
{
	...
	::odata::utility::seconds value(2318);
	auto odata_value = odata_primitive_value::make_primitive_value(value);
	auto json_string = json_writer->serialize(odata_value).to_string();
...
TEST(collection_of_primitive)
{
	...
	auto int32_value_1 = std::make_shared<odata_primitive_value>(edm_primitive_type::INT32(), ::odata::utility::conversions::print_string(100));
	auto int32_value_2 = std::make_shared<odata_primitive_value>(edm_primitive_type::INT32(), ::odata::utility::conversions::print_string(500));
	auto int32_value_3 = std::make_shared<odata_primitive_value>(edm_primitive_type::INT32(), ::odata::utility::conversions::print_string(400));
	auto int32_value_4 = std::make_shared<odata_primitive_value>(edm_primitive_type::INT32(), ::odata::utility::conversions::print_string(300));
	auto int32_value_5 = std::make_shared<odata_primitive_value>(edm_primitive_type::INT32(), ::odata::utility::conversions::print_string(200));

	auto collection_type = std::make_shared<edm_collection_type>(edm_primitive_type::INT32());
	auto collection_value = std::make_shared<odata_collection_value>(collection_type);
...
TEST(collection_of_enum)
{
	...
	auto collection_type = std::make_shared<edm_collection_type>(model->find_enum_type(U("AccessLevel")));
	auto collection_value = std::make_shared<odata_collection_value>(collection_type);
...
TEST(unicode_data_in_entity)
{
	...
	auto entity_value = std::make_shared<odata_entity_value>(model->find_entity_type(U("Account")));
	entity_value->set_value(U("AccountID"), (int32_t)100);
	entity_value->set_value(U("Country"), U("上海"));
